...
use App\Http\Controllers\Frontend\RevolutController;

use App\Http\Controllers\Administrative\ContactsController;
...
Route::post('customholidayform-submit',[MainFormsController::class,'customholidayformsubmit']);
Route::get('/customholidayform-row/{rowno}',[HomeController::class,'customholidayformrow']);

Route::post('custom-holiday-plan-submit',[MainFormsController::class,'customholidayplansubmit']);
Route::post('custom-holiday-plan-enquiry',[MainFormsController::class,'customholidayplanenquiry']);
...
Route::post('/administrative/contacts/exportcontacts', [ContactsController::class, 'exportcontacts']);

Route::controller(ContactsController::class)->group(function(){
    Route::get('/administrative/contacts/index','index')->name('administrative.contacts.index');
    Route::get('/administrative/contacts/emptycontacts','emptycontacts')->name('administrative.contacts.emptycontacts');
});
...
Route::get('/load-more-packages', [MainServicesController::class, 'loadMore']);
Route::get('/load-more-holidays-packages', [MainServicesController::class, 'loadMoreHolidaysPackages']);

Route::get('/e-payment', [HomeController::class, 'Epayment'])->name('epayment');
Route::post('/payment-process', [RevolutController::class, 'createPayment'])->name('revolut.create');
Route::get('/payment/success', [RevolutController::class, 'success'])->name('revolut.success');
Route::post('/payment/webhook', [RevolutController::class, 'webhook'])->name('revolut.webhook');

Route::get('/umrah-and-holiday-packages', [MainServicesController::class,'holidaypackageshome'])->name('services.holidaypackageshome');
Route::get('/umrah-with-{destinationpackages_url}-holidays', [MainServicesController::class,'holidaypackages'])->name('services.holidaypackages');
