...
@section('main-container')
    <div class="background-blogs col-12 float-start">
    ...
    <div class="container">
        <div class="row custome-margin-bottom">
            <div class="col-lg-12" id="blogsData">
            ...
            <div class="col-12 float-start d-block align-items-center justify-content-center mt-5 mb-5 text-center ">
                <button id="load-more-testimonials" data-page="2" class="explore-btn-new">read MORE</button>
            </div>
    ...
    <!-- Related Package Category Slider -->
