...
@section('main-container')
                        ...
                        <div class="panel-body">
                            <div class="form-wrap">
                                ...
                                <form data-toggle="validator" novalidate="true"
                                    action="{{ route('administrative.services.store') }}" method="post"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="services_name"
                                            ...
                                            data-error="Value Required." value="{{ old('services_name') }}" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @php
                                            ...
                                            $initialValue = old('services_details');
    ...
    @endphp
                        @foreach ($faqs as $faq)
    <option value="{{ $faq->faqs_id }}">{{ $faq->faqs_heading }}</option>
    @endforeach
                      </select>
                    </div-->
