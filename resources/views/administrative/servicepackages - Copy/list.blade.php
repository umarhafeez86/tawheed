											...
											<table id="datable_1" class="table  display table-hover mb-30">
												<thead>
													<tr>
														...
														<th>Service</th>
														<th>Hotel Info.</th>
														<th>Price {{ get_siteinfo('currency_symbol') }}</th>
														<th>Sort</th>
														<th>Status</th>
...
@endphp
                        ...
                        <tr>
                          ...
                          <td><strong style="color: #000">{{ $servicepackage->servicepackages_name }}</strong></td>
...
@endphp
						  ...
						  <td>
							<strong>Makkah:</strong>  {{ $servicepackage->servicepackages_makkah_hotel_name }}<br/>
							<strong>Madinah:</strong> {{ $servicepackage->servicepackages_madinah_hotel_name }}
						  </td>
