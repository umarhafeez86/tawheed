        ...
        <div class="panel-wrapper collapse in">
          <div class="panel-body">
            <div class="form-wrap">
              ...
              <form data-toggle="validator" novalidate="true" action="{{ route("administrative.hotelslogos.store") }}" method="post" enctype="multipart/form-data" >
              @csrf
                <div class="form-group">
                  <label class="control-label mb-10 text-left">Name</label>
                  <input type="text" name="hotelslogos_name" class="form-control @error("hotelslogos_name") is-invalid @enderror" data-error="Value Required." value="{{ old("hotelslogos_name") }}" required >
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="hotelslogos_link" class="form-control" value="{{ old("hotelslogos_link") }}" >
                </div>

                <div class="form-group">
                  <label class="control-label text-left">Sort</label>
                  <input type="text" name="hotelslogos_sort" class="form-control" value="{{ old("hotelslogos_sort") }}">
                </div>
