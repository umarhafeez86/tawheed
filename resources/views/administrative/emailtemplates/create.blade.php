        ...
        <div class="panel-wrapper collapse in">
          <div class="panel-body">
            <div class="form-wrap">
              ...
              <form data-toggle="validator" novalidate="true" action="{{ route("administrative.emailtemplates.store") }}" method="post" enctype="multipart/form-data" >
              @csrf
                <div class="form-group">
                  <label class="control-label mb-10 text-left">Email Title</label>
                  <input type="text" name="email_title" class="form-control @error("email_title") is-invalid @enderror" data-error="Value Required." value="{{ old("email_title") }}" required >
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="email_subject" class="form-control @error("email_subject") is-invalid @enderror" data-error="Value Required." value="{{ old("email_subject") }}" required >
                        <div class="help-block with-errors"></div>
                        @error("email_subject")
                        <p class="invalid-feedback">{{ $message }}</p>
                        @enderror
                ...
                <div class="form-group">
                  ...
                  $initialValue = old("email_content");
