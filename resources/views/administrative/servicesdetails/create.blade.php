        ...
        <div class="panel-wrapper collapse in">
          <div class="panel-body">
            <div class="form-wrap">
              ...
              <form data-toggle="validator" novalidate action="{{ route("administrative.servicesdetails.store") }}" method="post" enctype="multipart/form-data" >
              @csrf
              ...
              <div class="form-group">
                ...
                <input type="text" name="servicesdetails_heading" class="form-control @error("servicesdetails_heading") is-invalid @enderror" data-error="Value Required." value="{{ old("servicesdetails_heading") }}" required >
              ...
              <div class="form-group">
                  ...
                  $initialValue = old("servicesdetails_details");
                  CKFinder::SetupCKEditor( $CKEditor, '../../ckfinder/' ) ;
                  $code = $CKEditor->editor("servicesdetails_details", $initialValue);
                  echo $code;
                  @endphp
