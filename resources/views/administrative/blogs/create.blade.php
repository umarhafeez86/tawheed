        ...
        <div class="panel-wrapper collapse in">
          <div class="panel-body">
            <div class="form-wrap">
              ...
              <form data-toggle="validator" novalidate="true" action="{{ route("administrative.blogs.store") }}" method="post" enctype="multipart/form-data" >
              @csrf
                <div class="form-group">
                  <label class="control-label mb-10 text-left">Blog Heading</label>
                  <input type="text" name="blogs_name" class="form-control @error("blogs_name") is-invalid @enderror" data-error="Value Required." value="{{ old("blogs_name") }}" required >
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="blogs_url" class="form-control" value="{{ old("blogs_url") }}">
                </div>
                ...
                <div class="form-group">
                  ...
                  $initialValue = old("blogs_details");
                ...
                <div class="form-group col-xs-12 col-sm-4" style="padding-left:0px;">
                  ...
                  <input type="date" name="blogs_date" class="form-control" value="{{ old("blogs_date") }}">
                </div>

                <div class="form-group col-xs-12 col-sm-4" style="padding-left:0px;">
                  <label class="control-label mb-10 text-left">Author</label>
                  <input type="text" name="blogs_author" class="form-control" value="{{ old("blogs_author") }}">
                </div>

                <div class="form-group col-xs-12 col-sm-4" style="padding-left:0px;">
                  <label class="control-label mb-10 text-left">Tag</label>
                  <input type="text" name="blogs_tag" class="form-control" value="{{ old("blogs_tag") }}">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="blogs_sort" class="form-control" value="{{ old("blogs_sort") }}">
                </div>
