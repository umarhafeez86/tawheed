...
<div class="clearfix"></div>
              ...
              <form data-toggle="validator" novalidate="true" action="{{ route("administrative.partners.update",$partners->partners_id) }}" method="post" enctype="multipart/form-data" >
                @method('put')
                @csrf
                <div class="form-group">
                  <label class="control-label mb-10 text-left">Heading</label>
                  <input type="text" name="partners_name" class="form-control @error("partners_name") is-invalid @enderror" data-error="Value Required." value="{{ old("partners_name",$partners->partners_name) }}" required >
          ...
          <div class="form-group">
                  ...
                  <img height="50" src="{{ asset('uploads/partners/'.$partners->partners_image) }}">
                  @endif
          </div> 
          ...
          <div class="form-group">
            ...
            <input type="text" name="partners_link" class="form-control" value="{{ old("partners_link",$partners->partners_link) }}">
          </div>

          <div class="form-group">
            <label class="control-label text-left">Sort</label>
            <input type="text" name="partners_sort" class="form-control" value="{{ old("partners_sort",$partners->partners_sort) }}">
          </div>

          <div class="form-group">
            <label class="control-label mb-10 text-left">Status</label>
            <select name="partners_status" class="form-control">
              <option value="1" @if ($partners->partners_status==1) selected @endif>Enabled</option>
              <option value="0" @if ($partners->partners_status==0) selected @endif>Disabled</option>
            </select>
          </div>
