              ...
              <table class="table table-bordered text-white custom-table">
                <thead class="custom-thead">
                  <tr class="custom-tr">
                    ...
                    @endphp
                    <th class="custom-th @if ($compare_cols > 2) d-none d-sm-none d-md-block @endif" scope="col">{{ $package_info->servicepackages_name }}</th>
                    @php
                      $compare_cols++;
                    @endphp
                    @endforeach
                ...
                <tbody>
                  <tr class="custom-tr">
                    ...
                    <td class="custom-td @if ($compare_cols > 2) d-none d-sm-none d-md-block @endif">
