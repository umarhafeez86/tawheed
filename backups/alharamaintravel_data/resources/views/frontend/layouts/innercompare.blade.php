...
<head>
    ...
    <link rel="stylesheet" href="{{ url('frontend/assets/css/compare-packages.css') }}">
...
<!-- Right Main Section -->
    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 float-end right-panel-scroll position-relative">
        ...
        <div class="right-panel-container">
            <div class="col-12 ms-auto me-auto">
                ...
                @include('frontend.layouts.desktopmenuheader2')
                <!-- desktop view menu header -->
