        ...
        <div class="right-panel-container">
            <div class="col-12 ms-auto me-auto">
                ...
                <div class="col-12 float-start page_info_box">
                    {!! str_replace(array('<div>'),array('<div class="page_content_text col-12 float-start">'),$page_details) !!}
                    {{-- 
...
@endphp
    $(".roomtype").on("change", function() { 
      ...
      if ( $(this).val() != ""){
        ...
        $("#sel_roomtype2").html( $(this).val()+"" );
      }else{
        $("#sel_roomtype").html( "All Stars" );
        $("#sel_roomtype2").html( "All" );
      }
    ...
    $(".packagenights").on("change", function() { 
        ...
        if ($(this).val() != ""){
            ...
            $("#sel_packagenights2").html( $(this).val()+"" );
        }else{
            $("#sel_packagenights").html( "All Nights" );
            $("#sel_packagenights2").html( "All" );
        }
