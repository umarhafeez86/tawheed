        ...
        <div class="panel-wrapper collapse in">
          <div class="panel-body">
            <div class="form-wrap">
              ...
              <form data-toggle="validator" novalidate="true" action="{{ route("administrative.packages.store") }}" method="post" enctype="multipart/form-data" >
              @csrf
                <div class="form-group">
                  <label class="control-label mb-10 text-left">Packages Name</label>
                  <input type="text" name="packages_name" class="form-control @error("packages_name") is-invalid @enderror" data-error="Value Required." value="{{ old("packages_name") }}" required >
                ...
                <div class="form-group">
                  ...
                  <textarea name="packages_info" class="form-control" rows="5">{{ old("packages_info") }}</textarea>
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea name="packages_details" class="textarea_editor form-control" rows="5">{{ old("packages_details") }}</textarea>
                </div>
                ...
                <div class="form-group col-xs-12 col-sm-4" style="padding-left:0px;">
                  ...
                  <input type="text" name="packages_tag" class="form-control" value="{{ old("packages_tag") }}">
                </div>

                <div class="form-group col-xs-12 col-sm-4" style="padding-left:0px;">
                  <label class="control-label mb-10 text-left">Price 1</label>
                  <input type="text" name="packages_price" class="form-control" value="{{ old("packages_price") }}">
                </div>

                <div class="form-group col-xs-12 col-sm-4" style="padding-left:0px;">
                  <label class="control-label mb-10 text-left">Room Option 2</label>
                  <input type="text" name="packages_tag2" class="form-control" value="{{ old("packages_tag2") }}">
                </div>

                <div class="form-group col-xs-12 col-sm-4" style="padding-left:0px;">
                  <label class="control-label mb-10 text-left">Price 2</label>
                  <input type="text" name="packages_price2" class="form-control" value="{{ old("packages_price2") }}">
                </div>

                <div class="form-group col-xs-12 col-sm-4" style="padding-left:0px;">
                  <label class="control-label mb-10 text-left">Room Option 3</label>
                  <input type="text" name="packages_tag3" class="form-control" value="{{ old("packages_tag3") }}">
                </div>

                <div class="form-group col-xs-12 col-sm-4" style="padding-left:0px;">
                  <label class="control-label mb-10 text-left">Price 3</label>
                  <input type="text" name="packages_price3" class="form-control" value="{{ old("packages_price3") }}">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="packages_sort" class="form-control" value="{{ old("packages_sort") }}">
                </div>
